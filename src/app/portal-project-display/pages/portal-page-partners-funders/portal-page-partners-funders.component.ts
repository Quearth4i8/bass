...
@Component({
  selector: 'app-portal-page-partners-funders',
  templateUrl: './portal-page-partners-funders.component.html',
  styleUrls: ['./portal-page-partners-funders.component.scss'],
})
export class PortalPagePartnersFundersComponent implements OnInit {
